...
|------------------------|--------|-------------------|-------|
| **Entradas de usuario** | 4 | 3 | 12 |
| - Consulta por WhatsApp | 1 | X | |
| - Consulta por Web | 1 | X | |
| - Login administrador | 1 | X | |
| - Gestión base conocimiento | 1 | X | |
| **Salidas de usuario** | 3 | 4 | 12 |
| - Respuesta automática | 1 | X | |
| - Respuesta manual | 1 | X | |
| - Reportes de uso | 1 | X | |
| **Peticiones de usuario** | 2 | 3 | 6 |
| - Búsqueda semántica | 1 | X | |
| - Transferencia a asistente | 1 | X | |
| **Archivos** | 4 | 7 | 28 |
| - Base datos conversaciones | 1 | X | |
| - Base datos embeddings | 1 | X | |
| - Base datos usuarios | 1 | X | |
| - Logs de rendimiento | 1 | X | |
| **Interfaces externas** | 3 | 5 | 15 |
| - WhatsApp Business API | 1 | X | |
| - OpenAI API | 1 | X | |
| - Apache Spark | 1 | X | |

**Cuenta Total: 73 puntos de función**
